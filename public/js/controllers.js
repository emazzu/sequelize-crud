...
/*  SET URI global de donde se deben levantar los servicios */
this.servicesPath = "http://" + location.host + "/";


/*  MAIN    controller
            declara info global con visibilidad en toda la aplicación
*/
...
function dashboardFlotOne() {
       ...
       $scope.filterColumnsGet = function filterColumnsGet() {

            var urlSearch = "http://localhost:8080/filter-columns/wells";

            $http.get(urlSearch)

            .success(function (searchList) {

                $scope.filterColumnsFound = searchList;

            })

        };

        $scope.filterColumnSelected = { name: 'cName' };

        $scope.filterColumnSelectedShow = function filterColumnSelectedShow() {
...
/*  FILTER  controller
            Responsable de todo lo que tiene que ver con el filtro
            Vista que lo utiliza: topnavbar.html 
*/
function filterCtrl($scope, $http, $rootScope) {



        /*   DECLARE    condición, cuando se hace clic en Add, cada criterio de guarda en array
                        arrWhere:       filtro para visualización en pantalla
                        arrWhereReal:   filtro que realmente se aplica
        */
        $scope.arrWhere = new Array();
        $scope.arrWhereReal = new Array();


        var aaa = 0;


        /*  DECLARE     opciones disponibles para el filtro global x fecha, según lo que selecciona
                        ya está armada lña condición para SQL
        */
        $scope.globalDate = [
            {
                group: "grupo_1",
                name: "Día actual",
                condition: "(convert(varchar(10), [@DATE], 112) = convert(varchar(10), dateadd(d, 0, getdate()), 112))",
                operation: "0",
                from: "from",
                to: "to"
            },
            {
                group: "grupo_1",
                name: 'Semana actual',
                condition: "(convert(varchar(10), [@DATE], 112) BETWEEN convert(varchar(10), dateadd(wk, datediff(wk, 0, getdate()), 0), 112) AND convert(varchar(10), dateadd(wk, datediff(wk, 0, getdate()), 6), 112))",
                operation: "",
                from: "from",
                to: "to"
            },
            {
                group: "grupo_1",
                name: 'Mes actual',
                condition: "(convert(varchar(10), [@DATE], 112) BETWEEN convert(varchar(10), dateadd(mm, datediff(mm, 0, getdate()), 0), 112) AND convert(varchar(10), dateadd(ms, -3, dateadd(mm, 0, dateadd(mm, datediff(mm, 0, getdate()) +1, 0))), 112))",
                operation: "",
                from: "from",
                to: "to"
            },
            {
                group: "grupo_1",
                name: 'Cuarto actual',
                condition: "(year([@FECHA]) = year(getdate()) AND datepart(q, [FECHA]) = datepart(qq, getdate()))",
                operation: "",
                from: "from",
                to: "to"
            },
            {
                group: "grupo_1",
                name: 'Año actual',
                condition: "(convert(varchar(10), [DATE], 112) BETWEEN convert(varchar(10), dateadd(yy, datediff(yy, 0,getdate()), 0), 112) AND convert(varchar(10), dateadd(ms, -3, dateadd(yy, 0, dateadd(yy, datediff(yy, 0, getdate()) +1, 0))), 112))",
                operation: "",
                from: "from",
                to: "to"
            },
            {
                group: "grupo_2",
                name: "Día ant",
                condition: "(convert(varchar(10), [@DATE], 112) = convert(varchar(10), dateadd(d, ???, getdate()), 112))",
                operation: "1",
                from: "[@FECHA] = convert(varchar(10), getdate(), 112)",
                to: "[@FECHA] = convert(varchar(10), getdate(), 112)"
            },
            {
                group: "grupo_2",
                name: 'Semana ant',
            ...
            },
            {
                group: "grupo_2",
                name: 'Mes ant',
                condition: "(convert(varchar(10), [@DATE], 112) BETWEEN convert(varchar(10), dateadd(mm, datediff(mm, ???, getdate()), 0), 112) AND convert(varchar(10), dateadd(ms, -3, dateadd(mm, 0, dateadd(mm, datediff(mm, 0, getdate()) +1, 0))), 112))",
                operation: "1",
                from: "[@FECHA] = convert(varchar(10), getdate(), 112)",
                to: "[@FECHA] = convert(varchar(10), getdate(), 112)"
            },
            ...
            },
            {
                group: "grupo_3",
                name: "7",
                condition: "(convert(varchar(10), [Date], 112)  between convert(varchar(10), getdate()-7, 112) and convert(varchar(10), getdate(), 112))",
                operation: "",                
                from: "[@FECHA] = convert(varchar(10), getdate(), 112)",
                to: "[@FECHA] = convert(varchar(10), getdate(), 112)"
            },
            {
                group: "grupo_3",
                name: '15',
                condition: "(convert(varchar(10), [Date], 112)  between convert(varchar(10), getdate()-15, 112) and convert(varchar(10), getdate(), 112))",
                operation: "",                
                from: "[@FECHA] = convert(varchar(10), getdate(), 112)",
                to: "[@FECHA] = convert(varchar(10), getdate(), 112)"
            },
            {
                group: "grupo_3",
                name: '30',
                condition: "(convert(varchar(10), [Date], 112)  between convert(varchar(10), getdate()-30, 112) and convert(varchar(10), getdate(), 112))",
                operation: "",                
                from: "[@FECHA] = convert(varchar(10), getdate(), 112)",
                to: "[@FECHA] = convert(varchar(10), getdate(), 112)"
            },
            {
                group: "grupo_3",
                name: '60',
                condition: "(convert(varchar(10), [Date], 112)  between convert(varchar(10), getdate()-60, 112) and convert(varchar(10), getdate(), 112))",
                operation: "",                
                from: "[@FECHA] = convert(varchar(10), getdate(), 112)",
                to: "[@FECHA] = convert(varchar(10), getdate(), 112)"
            },
            {
                group: "grupo_3",
                name: '90',
                condition: "(convert(varchar(10), [Date], 112)  between convert(varchar(10), getdate()-90, 112) and convert(varchar(10), getdate(), 112))",
                operation: "",                
                from: "[@FECHA] = convert(varchar(10), getdate(), 112)",
                to: "[@FECHA] = convert(varchar(10), getdate(), 112)"
            },
            {
                group: "grupo_3",
                name: '120',
                condition: "(convert(varchar(10), [Date], 112)  between convert(varchar(10), getdate()-120, 112) and convert(varchar(10), getdate(), 112))",
                operation: "",                
                from: "[@FECHA] = convert(varchar(10), getdate(), 112)",
                to: "[@FECHA] = convert(varchar(10), getdate(), 112)"
            },
            {
                group: "grupo_3",
                name: '150',
                condition: "(convert(varchar(10), [Date], 112)  between convert(varchar(10), getdate()-150, 112) and convert(varchar(10), getdate(), 112))",
                operation: "",                
                from: "[@FECHA] = convert(varchar(10), getdate(), 112)",
                to: "[@FECHA] = convert(varchar(10), getdate(), 112)"
            },
            {
                group: "grupo_3",
                name: '180',
                condition: "(convert(varchar(10), [Date], 112)  between convert(varchar(10), getdate()-180, 112) and convert(varchar(10), getdate(), 112))",
                operation: "",                
                from: "[@FECHA] = convert(varchar(10), getdate(), 112)",
                to: "[@FECHA] = convert(varchar(10), getdate(), 112)"
            },
            {
                group: "grupo_3",
                name: '365',
                condition: "(convert(varchar(10), [Date], 112)  between convert(varchar(10), getdate()-365, 112) and convert(varchar(10), getdate(), 112))",
                operation: "",                
                from: "[@FECHA] = convert(varchar(10), getdate(), 112)",
                to: "[@FECHA] = convert(varchar(10), getdate(), 112)"
            }
       ...
       /*   GET columnas por las cuales se puede filtrar, según entidad */
       $scope.getFilterColumns = function getFilterColumns() {

            var urlSearch = servicesPath + "filterColumns/" + $scope.filterIdEntity;

            $http.get(urlSearch)

                .then(function (res) {

                    $scope.filterColumnsFound = res.data;

                    /*  DEFINE definimos que columna muesntra en la lista desplegable */
                    $scope.filterColumnSelected = { name: 'cName' };

                    /*  FOUND   valor por defecto, pero no se como asignarlo, por ahora dejo esto, pero no hace nada */
                    for (var index in $scope.filterColumnsFound) {
                        if ($scope.filterColumnsFound[index].cDefault == 1) {
                        }
                    }

                }, function(res) {

                    /*  ERROR   ver que hago x error */
        ...
        /*   BUILD condición global x fecha, según selección  */
        $scope.getGlobalDate = function(grupo, index) {

            var aux = 0;
            var conditionShow = $scope.globalDate[aux + index].condition;

            switch(grupo) {

                case 1:
                    aux = 0;
                    aaa = parseInt($scope.globalDate[aux + index].operation);
                    conditionShow = $scope.globalDate[aux + index].condition;
                    break;

                case 2:
                    aux = 5;
                    aaa = aaa - parseInt($scope.globalDate[aux + index].operation);
                    conditionShow = $scope.globalDate[aux + index].condition.replace("???", aaa.toString());
                    break;                
            ...
            $scope.globalDateFrom = conditionShow;
            $scope.globalDateTo = $scope.globalDate[aux + index].from;
            $scope.globalDateTo = $scope.globalDate[aux + index].to;
        ...
        /*   BUILD condición, según tipo de dato de la columna  */
        $scope.building = function () {
            ...
            //  CHECK si usuario utilizo criterio separado por coma o por espacio --> GENERATE array a,b,c - a b c
            var arrCriterion = ($scope.filterCriterion.indexOf(",") != -1) ? $scope.filterCriterion.split(",") : $scope.filterCriterion.split(" ");

            //  SWITCH tipo de dato de la columna seleccionada para poder armar condición, convierto a minuscula, para evitar error
            switch($scope.filterColumnSelected.cType.toLowerCase()) {
                ...
                case "list_manual":
                    ...
                    //  WHILE array
                    for (ele in arrCriterion) { 

                        //  CHECK si existe alguna condición --> ADD operador OR 
                        if ($scope.filterWhere != "") {
                            strOperator = " or ";
                        }

                        //  CHECK si condición contiene algo
                        if (arrCriterion[ele].trim() != "") {

                        //  BUILD condición - operador + nombre de columna entre corchetes + criterio reemplazando * por % para el LIKE
                        $scope.filterWhere += strOperator + "[" + $scope.filterColumnSelected.cName + "] like '" + arrCriterion[ele].trim() + "'";
                ...
                case "date":
                    ...
                    if (arrCriterion[arrCriterion.length-1].length < 10) {
                        break;
                    }
                    ...
                    for (ele in arrCriterion) {
                        ...
                        //  CHECK longitud del elemento del array, solo valido, cuando es 10, 
                        //        entra al controller, con el evento change, entra por cada caracter que ingreso
                        if (arrCriterion[ele].trim().length >= 10) {

                            //  CONVERT fecha a formato ISO nativo YYYYDDMM
                            //          para que moment.js valide en forma nativa y no necesite locate.js("es") que ocupa 44K
                            strOriginal = arrCriterion[ele];
                            arrCriterion[ele] = arrCriterion[ele].trim().substr(6, 4) + arrCriterion[ele].trim().substr(0, 2) + arrCriterion[ele].trim().substr(3, 2);

                            //  VALIDATE fecha --> DELETE elemento invalido, aseguro que la condición no falle
                            if (! moment(arrCriterion[ele], "YYYYDDMM", true).isValid() || strOriginal.length > 10 ) {

                                //  DELETE valor invalido de criterio
                                $scope.filterCriterion = $scope.filterCriterion.replace(strOriginal, "");

                                //  DELETE elemento
                                arrCriterion.splice(ele, 1);
                            }
                            else {
                                //  CONVERT a ISO, como la necesito después, esto porque ya esta validada
                                arrCriterion[ele] = arrCriterion[ele].substr(0, 4) + arrCriterion[ele].substr(6, 2) + arrCriterion[ele].substr(4, 2);
                            }
                        }
                    ...
                    //  WHILE array
                    for (ele = 0; ele < arrCriterion.length; ele+=2) {

                        //  CHECK si existe condición previa --> ADD operador OR 
                        if ($scope.filterWhere != "") {
                            strOperator = " or ";
                        }

                        //  CHECK si única condición
                        if (ele == arrCriterion.length-1) {
    
                            //  BUILD condición - operador + nombre de columna + criterio un solo valor: ([columna] = valor1)
                            $scope.filterWhere += strOperator + "[" + $scope.filterColumnSelected.cName + "] = '" + arrCriterion[ele] + "'";
                        }
                        else {
    
                            //  BUILD condición - operador + nombre de columna entre corchetes + criterio rango: ([columna] between valor1 and valor2)
                            $scope.filterWhere += strOperator + "[" + $scope.filterColumnSelected.cName + "] between '" + arrCriterion[ele] + "' and '" + arrCriterion[ele+1] + "'";
                        }
                    }
                ...
                case "numeric":
                    ...
                    for (ele in arrCriterion) {
                        ...
                        //  VALIDATE número --> DELETE elemento invalido, aseguro que la condición no falle
                        if ( isNaN(arrCriterion[ele].trim()) == true ) {

                            //  DELETE valor invalido de criterio
                            $scope.filterCriterion = $scope.filterCriterion.replace(arrCriterion[ele], "");
                    ...
                    for (ele = 0; ele < arrCriterion.length; ele+=2) { 
                        ...
                        if (ele == arrCriterion.length-1) {
                            ...
                            //  BUILD condición - operador + nombre de columna + criterio un solo valor: ([columna] = valor1)
                            $scope.filterWhere += strOperator + "[" + $scope.filterColumnSelected.cName + "] = " + arrCriterion[ele].trim() + "";
                        }

                        else {

                            //  BUILD condición - operador + nombre de columna entre corchetes + criterio rango: ([columna] between valor1 and valor2)
                            $scope.filterWhere += strOperator + "[" + $scope.filterColumnSelected.cName + "] between " + arrCriterion[ele].trim() + " and " + arrCriterion[ele+1].trim() + "";
                        }
                    }
                ...
                case "bit":
                    ...
                    for (ele in arrCriterion) { 
                        ...
                        //  CHECK según criterio --> ADD comodin
                        switch(arrCriterion[ele].trim().toLowerCase()) {
                        ...
                        if (strComodin != "") {
                            ...
                            //  BUILD condición - operador + nombre de columna entre corchetes + criterio un solo valor: ([columna] = valor1)
                            $scope.filterWhere += strOperator + "[" + $scope.filterColumnSelected.cName + "]" + strComodin + "";
                        }
                    }
            ...
            //  WHILE array, BUILD condición
            //alert($scope.filterColumnSelected.cType);

            //$scope.condition = $scope.filterCriterion;
        ...
        /*  KEYPRESS    Cuando esta tipeando un criterio, si apreta ENTER, llamo a funcion ADD, solo usabilidad */
        ...
        /*   ADD cada criterio en un array para visualización y otro para aplicar where */
        $scope.add = function() {

            /*  CHECK   si columna seleccionada == undefined, salgo */
            if ($scope.filterColumnSelected.cName === undefined) {

                /*  CLEAR   criterio ng-model */
                $scope.filterCriterion = null;
                return; 
            }

            /*  CHECK   si criterio == null, salgo */
            if ($scope.filterWhere == null) {
                return; 
            }

            /*  ADD     criterio a array  */
            $scope.arrWhere.push("(" + $scope.filterWhere + ")");
            $scope.arrWhereReal.push("(" + $scope.filterWhere + ")");
        ...
        /*   TOOGLE agrega o elimina cada criterio, al array para aplicar where  */
        $scope.toggle = function(ele) {

            var index = $scope.arrWhereReal.indexOf(ele);

            /*  CHECK   si no está, lo agrega, si no, lo elimina */
            if (index == -1) {
                $scope.arrWhereReal.push(ele);
            }
            else {
                $scope.arrWhereReal.splice(index, 1);
            }
        ...
        /*   DELETE criterio de array para visualización y para aplicar */
        $scope.delete = function(ele) {

            var index = $scope.arrWhere.indexOf(ele);
                 
            if (index != -1) {
                $scope.arrWhere.splice(index, 1);
            }
 
            index = $scope.arrWhereReal.indexOf(ele);
        ...
        /*   SEARCH aplica el where  */
        $scope.search = function () {


            /*  CHECK   si criterio != null, fuerzo Add, para que el usuario no tenga que hacer
                        Add y luego Search, en caso de que no quiera agregar mas condiciones y
                        quiera hacer clic directamente en Search 
            */
             if ($scope.filterCriterion != null) {
                $scope.add(); 
            }

            /*  CHECK   si criterio vacio, salgo  */
            if ($scope.arrWhereReal.length == 0) {
                return; 
            }

            var urlSearch = servicesPath + "filterSearch/" + $rootScope.authentication.user_id + "/" + $rootScope.IdEntity + "/" + $rootScope.whereSearch + "/" + $scope.arrWhereReal;
            ...
            $http.get(urlSearch)
                ...
                .then(function (res) {
					...
					/*	GET filas filtradas */
                    $scope.rowsFound = res.data;

                    /*  RELOAD renderiza nuevamente cada vez que se aplica el filtro */
                	...
                	/*	ERROR 	despues veo que hago acá */
...
//          DRAGABLE
        ...
        //         /*  DELETE  criterio de array visualización y array aplicar */                
        //         var ele = $scope.arrWhere[ui.item.index()]; 
        //         var index = $scope.arrWhere.indexOf(ele);
        ...
        //         // alert("UPDATE " + $scope.arrWhere[ui.item.index()]);
        //     },
        //     receive: function(e, ui) {
        //         // alert($scope.arrWhere[ui.item.index()]);
        //     },
        //     out: function(e, ui) {
        //         // alert("OUT " + $scope.arrWhere[ui.item.index()]);
        //     }
        //     // ,
        //     // connectWith: ".group",
        //     // axis: 'x, y'
...
function documentsCtrl($scope, $http) {
        ...
        $scope.search = function () {
 			...
 			var urlSearch = servicesPath + "wellsDocuments";
            ...
            $http.get(urlSearch)
                ...
                .then(function (res) {
                    ...
                    $scope.itemsFound = res.data;
                    $scope.rowsFound = res.data.length;
        ...
        $scope.download = function (ele, index) {

            var urlSearch = servicesPath + "file/" + ele.Extention + "." + ele.Extention;
...
angular
    ...
    .controller('filterCtrl', filterCtrl)                         // emazzu - 09/07/2015
    .controller('documentsCtrl', documentsCtrl)                   // emazzu - 09/07/2015    
